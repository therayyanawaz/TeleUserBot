...
LLM_MODEL = _env_str("LLM_MODEL", "nvidia/nemotron-3-ultra-550b-a55b:free")  # type: str
...
RECENCY_HALF_LIFE_SEC = _env_float("RECENCY_HALF_LIFE_SEC", 900.0)  # type: float
...
DIGEST_HEADLINE_CONTEXT_ENABLED = _env_bool("DIGEST_HEADLINE_CONTEXT_ENABLED", True)  # type: bool
DIGEST_HEADLINE_CONTEXT_MAX_ITEMS = _env_int("DIGEST_HEADLINE_CONTEXT_MAX_ITEMS", 2)  # type: int
DIGEST_HEADLINE_CONTEXT_HOURS_BACK = _env_int("DIGEST_HEADLINE_CONTEXT_HOURS_BACK", 168)  # type: int
DIGEST_HEADLINE_CONTEXT_TELEGRAM_MAX_MESSAGES = _env_int(
    "DIGEST_HEADLINE_CONTEXT_TELEGRAM_MAX_MESSAGES",
    8,
)  # type: int
DIGEST_HEADLINE_CONTEXT_WEB_MAX_RESULTS = _env_int(
    "DIGEST_HEADLINE_CONTEXT_WEB_MAX_RESULTS",
    6,
)  # type: int
