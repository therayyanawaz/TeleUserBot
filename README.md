...
```
Other free models: `qwen/qwen3-coder:free`, `openai/gpt-oss-120b:free`, `meta-llama/llama-3.3-70b-instruct:free`, `google/gemma-4-31b-it:free`.
...
LLM_PROVIDER=codex
CODEX_MODEL=gpt-5.4-mini
OPENAI_AUTH_ENV_ONLY=false  # local interactive
# OR for headless:
OPENAI_AUTH_ENV_ONLY=true
TG_USERBOT_AUTH_JSON_B64="..."
```
