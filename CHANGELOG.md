...
- `0250a0b` feat: add deterministic radicalized news moderation
...
- `edc0ea9` docs: update changelog [skip ci]
- `baee4f4` docs: update changelog [skip ci]
- `8a69cb4` docs: update changelog [skip ci]
- `d6e9fc3` docs: update changelog [skip ci]
- `9c43807` docs: add autogenerated changelog workflow

### CI

- `2cc0f4c` ci: avoid optional heavy deps in github actions
- `6b2faf3` ci: harden deploy workflow and test gate

### Chores

- `2cb5c4f` chore: ignore local sqlite data directory
- `bbc92c4` chore: remove empty codex marker
